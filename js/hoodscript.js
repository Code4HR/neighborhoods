...
var myCities = [  //NAME AND BOUNDS OF CITIES
  {name:"NewportNews",bnds:[[37.127,-76.536],[37.018,-76.450]]},
  {name:"Hampton", bnds:[[37.085,-76.422],[37.003,-76.306]]},
  {name:"Norfolk",bnds:[[36.950,-76.296],[36.842,-76.286]]}
]
,tblName = "neighborhoods" // cartoDB table name
,usrName = "jonahadkins" // your cartoDB username
,brandText = "Code for Hampton Roads" // top left text and link on site
,brandLink = "https://twitter.com/Code4HR" //top left link on site
,giturl = "https://github.com/jonahadkins/neighborhoods" //Only change this if you want to link to a fork you made, otherwise you can leave the link to the original repo
,twiturl = "https://twitter.com/jonahadkins" //Links to my twit acct, change it if you want or remove twitter link altogether
,myPath = "https://jonahadkins.cartodb.com/api/v2"; //this is the root path to your cartoDB instance with the v2 api param
/*--------------------------
...
,toner = L.tileLayer('https://{s}.tiles.mapbox.com/v4/jonahadkins.n1pkkk2c/{z}/{x}/{y}.png?access_token=pk.eyJ1Ijoiam9uYWhhZGtpbnMiLCJhIjoiRlVVVkx3VSJ9.9sdVEK_B_VkEXPjssU5MqA', {
    attribution: '<a href="http://www.mapbox.com/about/maps/" target="_blank">Mapbox &amp; OpenStreetMap</a>'
